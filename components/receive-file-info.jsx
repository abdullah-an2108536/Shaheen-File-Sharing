...
export default function ReceiveFileInfo({ searchParams }) {
  ...
  if (!senderEmail || !recipientEmail || !fileName || !senderPublicKey) {
    return (
      ...
      <CustomButton
          ...
          onClick={() => router.push("/receive/download")}
          fullWidth
 ...
 before:bg-white/20 before:rounded-md
            before:opacity-10 before:animate-pulse pointer-events-auto
            hover:shadow-xl hover:scale-105 transition-all my-5
          "
        />
      <Card>
  ...
  return (
    <div><Card>
          ...
          <div className="space-y-4">
            ...
            <div className="border rounded-md p-4 bg-white">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Share the secure link directly via WhatsApp with your
                recipient's phone number. This method provides additonal trust
                as the message will be sent from you phone number to the
                reciever.
              </p>
        ...
        {isComplete && (
          <div className="rounded-md bg-muted p-4">
            ...
            <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground">
              <li>
                The sender ({senderEmail}) will receive an email with a link to
                securely encrypt and upload the file using the established keys
              </li>
      ...
      <CardFooter className="border-t p-4 text-center text-sm text-muted-foreground">
        Shaheen File Sharing uses end-to-end encryption to ensure your files
    ...
    <CustomButton
        ...
        color="bg-gradient-to-r from-green-500 via-blue-500 to-indigo-500"
        className=" 
            text-white py-3 rounded-md shadow-lg
            relative overflow-hidden border border-white/10
